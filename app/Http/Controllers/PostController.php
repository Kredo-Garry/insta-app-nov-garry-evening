...
use Illuminate\Support\Facades\Auth; //to handle authentication
...
class PostController extends Controller
{
    ...
    /**
     * Define constructor --  Inside our constructor we instantiated object of Category and Post class once
     */
    ...
    {   
         ...
         */
        $selected_categories = [];
        # ex: 3 categories --> 1 travel, 2 food , 3 lifestyle
