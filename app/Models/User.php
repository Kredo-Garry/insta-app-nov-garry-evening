...
class User extends Authenticatable
{
    ...
    public function isFollowed(){
         ...
         * Firstly, get all the followers of the User ( $this->followers() ). Then, from that list, search for the Auth User from the follower_id column ( where('follower_id', Auth::user()->id) )
         */
    }
